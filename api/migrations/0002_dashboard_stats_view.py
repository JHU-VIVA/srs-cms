...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunSQL(
            sql='CREATE INDEX IF NOT EXISTS idx_events_type_outcome_date ON events (event_type, preg_outcome_date);',
            reverse_sql='DROP INDEX IF EXISTS idx_events_type_outcome_date;',
        ),
        migrations.RunSQL(
            sql='CREATE INDEX IF NOT EXISTS idx_events_type_id_desc ON events (event_type, id DESC);',
